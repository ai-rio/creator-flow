...
const CommandIcon = ({ size = 24, className = '' }) => (
  <svg
...
const AC_SummonsToTheForge = ({ cta, theme = 'dark' }) => {
      ...
      >
        ...
        <div className='relative z-10 flex flex-col items-center p-8 text-center'>
          ...
          <p className={`mx-auto mt-2 max-w-md ${currentTheme.text}`}>
            You've seen the theory. Now it's time to command the practice. This is the entry point to the operational
            command center.
          </p>
          <a
            href={cta.href}
