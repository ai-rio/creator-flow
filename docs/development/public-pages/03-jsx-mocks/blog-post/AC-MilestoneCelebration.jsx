...
const Particles = ({ isBursting, theme }) => {
...
const AC_MilestoneCelebration = ({ metric, metricLabel, title, children, theme = 'dark' }) => {
...
export default function App() {
  ...
  return (
    <div className={`min-h-[200vh] p-8 font-sans transition-colors duration-500 sm:p-12 ${pageThemes[theme]}`}>
      <div className='mx-auto max-w-3xl'>
        ...
        <AC_MilestoneCelebration metric='10,000' metricLabel='Followers' title='Community Command' theme={theme}>
          <p>
            You've officially surpassed the 10k follower threshold. Your voice is now a significant force in the market,
            capable of shaping trends and commanding attention.
          </p>
