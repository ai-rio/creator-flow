...
const teamMembers = [
    {
        ...
        philosophy: 'A system\'s elegance is measured by its resilience under maximum pressure. We built CreatorFlow to be unbreakable during a viral storm.',
        imageUrl: 'https://placehold.co/500x500/0A090F/FFF?text=AT'
    },
    {
        name: 'Dr. Lena Petrova',
        role: 'Growth Intelligence',
        philosophy: 'Data is useless noise. Actionable wisdom is the only metric that matters. My work is to turn raw data into your next strategic move.',
        imageUrl: 'https://placehold.co/500x500/0A090F/FFF?text=LP'
    },
    {
        name: 'Marcus Cole',
        role: 'Creator Experience Lead',
        philosophy: 'Every click, every pixel, every interaction is either adding to the chaos or contributing to command. There is no middle ground.',
        imageUrl: 'https://placehold.co/500x500/0A090F/FFF?text=MC'
    },
    {
        name: 'Sofia Chen',
        role: 'Automation & Fulfillment',
        philosophy: 'We automate the predictable so our creators can master the unpredictable. Repetitive tasks are the enemy of creative growth.',
        imageUrl: 'https://placehold.co/500x500/0A090F/FFF?text=SC'
    },
];

// --- Architect Card Component ---
const ArchitectCard = ({ member, theme }) => {
        ...
        >
            ...
            >
                <div className="flex h-full flex-col">
                    <img src={member.imageUrl} alt={member.name} className="h-40 w-40 rounded-full object-cover border-2 border-slate-100/10" />
                    ...
                    <p className={`flex-grow text-lg italic ${theme.textSecondary}`}>"{member.philosophy}"</p>
                </div>
            </motion.div>
        </motion.div>
    );
...
// --- Main Component ---
export default function AP030TheTeam() {
