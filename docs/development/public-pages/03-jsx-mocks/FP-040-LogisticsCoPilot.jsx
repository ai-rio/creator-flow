...
import { Sun, Moon, Package, Zap, X } from 'lucide-react';

// --- SVG Icons for Carriers (replaces react-icons dependency) ---
const UpsIcon = ({ size = 48 }) => (
...
const FP040LogisticsCoPilot = ({ theme }) => {
    const [state, setState] = useState('idle'); // idle -> calculating -> revealed
...
const CarrierNodes = ({ state, theme }) => (
...
const ResultTooltip = ({ theme, onReset }) => (
    <motion.div
