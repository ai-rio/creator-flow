    ...
    <footer className='pb-16 pt-0 md:pb-32'>
      <div className='mx-auto max-w-5xl px-6'>
        <Link
          href='/'
          aria-label='go home'
          className='mx-auto flex size-fit items-center gap-2 text-xl font-bold text-foreground'
        >
        ...
        <div className='my-8 flex flex-wrap justify-center gap-6 text-sm'>
          {links.map((link, index) => (
            <Link key={index} href={link.href} className='block text-muted-foreground duration-150 hover:text-primary'>
