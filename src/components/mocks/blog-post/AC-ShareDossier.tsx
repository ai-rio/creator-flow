...
const TwitterX = ({ size = 24, className = '' }: any) => (
  <svg
...
const Linkedin = ({ size = 24, className = '' }: any) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const Link = ({ size = 24, className = '' }: any) => (
  <svg
...
const Check = ({ size = 24, className = '' }: any) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size}
    height={size}
...
const AC_ShareDossier: React.FC<any> = ({ articleTitle, theme = 'dark' }: any) => {
