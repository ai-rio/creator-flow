...
const CalibrationSlider: React.FC<any> = ({
  label,
  value,
  min,
  max,
...
const AC_ProfitCommandDashboard: React.FC<any> = ({ initialValues, theme = 'dark' }: any) => {
  ...
  const handleMouseMove = (e: React.MouseEvent | React.ChangeEvent<HTMLInputElement>) => {
    if (!cardRef.current) return;
    const rect = (cardRef.current as any).getBoundingClientRect();
    (cardRef.current as any).style.setProperty('--mouse-x', `${(e as any).clientX - rect.left}px`);
    (cardRef.current as any).style.setProperty('--mouse-y', `${(e as any).clientY - rect.top}px`);
  };
          ...
          <div className='input-command-section space-y-4 lg:col-span-3'>
            ...
            <div className='space-y-4 pt-4'>
              <CalibrationSlider
                ...
                max={100}
                step={0.5}
                onChange={(e: any) => setValues((v: any) => ({ ...v, materialCost: parseFloat(e.target.value) }))}
                unit='$'
                theme={theme}
              />
              <CalibrationSlider
                ...
                max={100}
                step={0.5}
                onChange={(e: any) => setValues((v: any) => ({ ...v, laborCost: parseFloat(e.target.value) }))}
                unit='$'
                theme={theme}
              />
              <CalibrationSlider
                ...
                max={200}
                step={1}
                onChange={(e: any) => setValues((v: any) => ({ ...v, desiredMargin: parseFloat(e.target.value) }))}
                isPercentage
                theme={theme}
              />
            </div>
              ...
              <div className='overflow-hidden'>
                <div className='space-y-4 pt-4'>
                  <CalibrationSlider
                    ...
                    max={50}
                    step={0.25}
                    onChange={(e: any) => setValues((v: any) => ({ ...v, shippingCost: parseFloat(e.target.value) }))}
                    unit='$'
                    theme={theme}
                  />
                  <CalibrationSlider
                    ...
                    max={25}
                    step={0.1}
                    onChange={(e: any) => setValues((v: any) => ({ ...v, tiktokFee: parseFloat(e.target.value) }))}
                    isPercentage
                    theme={theme}
                  />
                  <CalibrationSlider
                    ...
                    max={10}
                    step={0.1}
                    onChange={(e: any) => setValues((v: any) => ({ ...v, paymentFee: parseFloat(e.target.value) }))}
                    isPercentage
                    theme={theme}
                  />
                  <CalibrationSlider
                    ...
                    max={10}
                    step={0.1}
                    onChange={(e: any) => setValues((v: any) => ({ ...v, packagingCost: parseFloat(e.target.value) }))}
                    unit='$'
                    theme={theme}
                  />
                  <CalibrationSlider
                    ...
                    max={20}
                    step={0.1}
                    onChange={(e: any) => setValues((v: any) => ({ ...v, marketingCost: parseFloat(e.target.value) }))}
                    unit='$'
                    theme={theme}
                  />
                  <CalibrationSlider
                    ...
                    max={30}
                    step={0.5}
                    onChange={(e: any) => setValues((v: any) => ({ ...v, returnRate: parseFloat(e.target.value) }))}
                    isPercentage
                    theme={theme}
                  />
                </div>
