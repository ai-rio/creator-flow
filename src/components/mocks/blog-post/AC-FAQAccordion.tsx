...
const AC_FAQAccordion: React.FC<any> = ({ items, theme = 'dark' }: any) => {
...
export default function App(): React.JSX.Element {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: (
        <p>
          By formatting content in a direct question-and-answer format, we create perfect &quot;answer blocks.&quot;
          This structure mirrors the &quot;People Also Ask&quot; feature in search and is easily parsable by AI,
          increasing the likelihood of being featured in search results and AI summaries.
        </p>
      ),
    },
    {
