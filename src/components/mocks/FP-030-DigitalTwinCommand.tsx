...
const BriefingTooltip: React.FC<any> = ({ activePod, theme  }: any) => {
    ...
    return (
        ...
        {activePod && (
            ...
            >
                <div className="p-4 border-b" style={{ borderColor: theme[(podData as any)?.color] }}>
                    <h4 className="font-bold" style={{ color: theme[(podData as any)?.color] }}>{(podData as any)?.title} Briefing</h4>
                </div>
