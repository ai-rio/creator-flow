...
// --- Main Hero Component ---
export default function AP010Hero(): React.JSX.Element {
  ...
  return (
    <div style={{ background: currentTheme.background }} className='font-sans antialiased'>
      ...
      <div className='relative mx-auto flex min-h-screen w-full max-w-7xl flex-col items-center justify-center overflow-hidden px-4 pt-20 text-center'>
        ...
        >
          <h1 className={`text-6xl font-black md:text-8xl ${currentTheme.textPrimary}`}>The Architects of Scale.</h1>
...
const ArchitectPrism = ({ isHovered, theme }: any) => (
  <motion.div
...
const PrincipleNode: React.FC<any> = ({ principle, onHoverStart, theme }: any) => {
