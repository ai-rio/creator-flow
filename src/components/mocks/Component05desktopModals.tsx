            ...
            <GlassPane className='relative w-full max-w-md p-6'>
              ...
              {type === 'destructive' && (
                <div className='mt-4'>
                  ...
                  <input
                    ...
                    className='w-full rounded-lg border border-slate-400/50 bg-slate-200/50 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:border-slate-700/50 dark:bg-slate-800/50 dark:focus:ring-purple-400'
                  />
                </div>
              )}
              ...
              <div className='mt-6 flex justify-end gap-4'>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className='rounded-lg border border-slate-500/50 bg-transparent px-5 py-2 font-bold transition-colors hover:bg-slate-500/20 dark:border-slate-600 dark:hover:bg-slate-700/50'
                >
                  {cancelText}
                </motion.button>
                <motion.button
                  ...
                  className={`rounded-lg px-5 py-2 font-bold transition-colors
                                        ${
                                          type === 'destructive'
                                        ...
                                        ${
                                          isConfirmationDisabled
                                            ...
                                            : 'hover:bg-red-700 dark:hover:bg-slate-200'
                                        }
                                    `}
                >
                  {confirmText}
...
function AppContent() {
  ...
  return (
    <div className='relative flex min-h-screen items-center justify-center bg-slate-100 font-sans text-slate-900 dark:bg-[#0A090F] dark:text-slate-200'>
      ...
      <GlassPane className='p-8 text-center'>
        ...
        <p className='mt-2 text-slate-600 dark:text-slate-400'>High-stakes decision-making for the modern CEO.</p>
        <div className='mt-8 flex gap-4'>
          <motion.button
            onClick={() => setStandardModalOpen(true)}
            whileHover={{ scale: 1.05 }}
            className='rounded-lg bg-slate-800 px-6 py-3 font-bold text-white dark:bg-slate-200 dark:text-slate-900'
          >
            Trigger Standard Modal
          </motion.button>
          <motion.button
