...
import { Zap, Target, Flame, Bot, Sun, Moon, ArrowLeft, Clock, Music, Timer, MapPin, Package, Warehouse, Truck, CheckCircle, Sparkles, ClipboardList } from 'lucide-react';
...
const OrderManagementView = () => {
    ...
    const [activeFilter, setActiveFilter] = useState<string>('priority');
