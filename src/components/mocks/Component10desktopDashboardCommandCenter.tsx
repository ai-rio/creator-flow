...
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div
        className='rounded-lg border border-teal-500/50 bg-white/80 p-3 shadow-lg backdrop-blur-sm dark:bg-gray-900/80'
...
export default function CreatorFlowDashboard(): React.JSX.Element {
  ...
  return (
    <div className={theme}>
      <div className='flex min-h-screen bg-gray-100 font-sans text-gray-800 transition-colors duration-300 dark:bg-[#111827] dark:text-gray-300'>
        {/* Sidebar */}
        <motion.div
          className='z-20 flex flex-col border-r border-gray-200 bg-white transition-all duration-300 ease-in-out dark:border-gray-800 dark:bg-[#111827]'
        ...
        >
          ...
          <nav className='flex-1 space-y-4 px-4 py-6'>
            <a
              href='#'
              className='flex items-center rounded-lg bg-gray-200/50 p-3 text-gray-900 dark:bg-gray-800 dark:text-gray-300'
            >
            ...
            <a
              href='#'
              className='flex items-center rounded-lg p-3 text-gray-500 hover:bg-gray-200/50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200'
            >
          ...
          <div className='space-y-4 border-t border-gray-200 px-4 py-6 dark:border-gray-800'>
            <a
              href='#'
              className='flex items-center rounded-lg p-3 text-gray-500 hover:bg-gray-200/50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200'
            >
        ...
        <main className='flex-1 overflow-y-auto p-8'>
          <header className='mb-8 flex items-center justify-between'>
            <div>
              ...
              <p className='mt-1 text-gray-500 dark:text-gray-400'>
                Welcome back, Alex. Here's your enterprise at a glance.
              </p>
            </div>
            <button
              onClick={toggleTheme}
              className='rounded-full bg-gray-200/80 p-3 text-gray-800 transition-colors duration-200 hover:bg-gray-300 dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-gray-700'
          ...
          >
            ...
            {kpiData.map((kpi) => (
              <motion.div
                key={kpi.title}
                className='col-span-12 rounded-2xl border border-gray-200 bg-white/70 p-6 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/50 sm:col-span-6 lg:col-span-3'
            ...
            <motion.div
              className='relative col-span-12 row-span-2 overflow-hidden rounded-2xl border border-gray-200 bg-white/70 p-6 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/50 lg:col-span-8'
              variants={itemVariants}
            >
              <ParticleCanvas />
              <div className='relative z-10'>
                <h2 className='mb-4 text-xl font-semibold text-gray-900 dark:text-white'>Revenue Masterpiece</h2>
            ...
            {/* Crisis Command */}
            <motion.div
              className='col-span-12 rounded-2xl border border-gray-200 bg-white/70 p-6 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/50 lg:col-span-4'
              variants={itemVariants}
            >
            ...
            <motion.div
              className='col-span-12 rounded-2xl border border-gray-200 bg-white/70 p-6 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/50'
              variants={itemVariants}
            >
              <h2 className='mb-4 flex items-center text-xl font-semibold text-gray-900 dark:text-white'>
              ...
              <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                <div className='rounded-lg bg-gray-200/50 p-4 dark:bg-gray-800/50'>
                  <p className='font-semibold text-teal-600 dark:text-teal-300'>Growth Opportunity</p>
                  <p className='mt-1 text-gray-700 dark:text-gray-300'>
                    Repeat customers are 3x more likely to buy "Creator Hoodie". Recommend a targeted email campaign.
                  </p>
                </div>
                <div className='rounded-lg bg-gray-200/50 p-4 dark:bg-gray-800/50'>
                ...
                <div className='rounded-lg bg-gray-200/50 p-4 dark:bg-gray-800/50'>
                  ...
                  <p className='mt-1 text-gray-700 dark:text-gray-300'>
                    The "Limited Edition Cap" has a 35% higher AOV than other products. Feature it on the homepage.
                  </p>
                </div>
              </div>
            </motion.div>
